...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${realScrolled
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8 text-sm font-medium">
          ...
          <NavLink to="/nosotros" className={({ isActive }) => linkClass(isActive)}>
            Nosotros
          </NavLink>

          <NavLink to="/servicios" className={({ isActive }) => linkClass(isActive)}>
            Servicios
          </NavLink>

          <NavLink to="/productos" className={({ isActive }) => linkClass(isActive)}>
            Productos
          </NavLink>

          <NavLink to="/capacitaciones" className={({ isActive }) => linkClass(isActive)}>
            Capacitaciones
          </NavLink>
