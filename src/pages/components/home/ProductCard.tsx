...
export default function ProductCard({ p }: { p: Product }) {
  return (
    <div className="snap-start shrink-0 w-[85%] sm:w-[60%] md:w-[46%] lg:w-[32%] xl:w-[28%] bg-white rounded-2xl shadow border border-gray-100 overflow-hidden flex flex-col">
      ...
      <div className="p-5 flex flex-col grow">
        ...
        <div className="mt-auto pt-4 flex gap-2">
          <a href="/productos" className="inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold border hover:bg-gray-50">
